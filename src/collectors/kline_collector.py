...
def _fetch_eastmoney_klines(
    ...
    """Fetch daily kline from Eastmoney as CN long-history fallback."""
...
class KlineCollector:
    ...
    def get_klines(self, symbol: str, days: int = 60) -> list[KlineData]:
        """获取日K线数据"""
        tencent_sym = _tencent_symbol(symbol)
        ...
        try:
            ...
            # CN 回退到 Eastmoney
            fb = _fetch_eastmoney_klines(symbol, min(max(days, 3000), 20000))
